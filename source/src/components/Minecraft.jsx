...
export function Minecraft() {
    ...
    const [{ blob, run }, setSkin] = useReducer((state, data) => {
    ...
    return (
        <div className="p-5">
            ...
            <div className="Minecraft">
                ...
                >
                    <Skinview3d
                        skinUrl={`data:image/png;base64,${blob}`}
                        height={300}
                        width={200}
                        onReady={skinViewer => {
                            ...
                            axios.get("https://stevecors.herokuapp.com/https://api.ashcon.app/mojang/v2/user/MrZillaGold")
                                ...
                                .then(({ textures }) => {
                                    setSkin({
                                        blob: textures.skin.data
                                    });

                                    skinViewer.detectModel = false;
                                    skinViewer.playerObject.skin.slim = textures.slim;
                                })
                                .catch(console.log);
                        }}
                    />
